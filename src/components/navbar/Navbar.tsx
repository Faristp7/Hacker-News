                ...
                <div className='flex justify-between'>
                    <div className='flex justify-between'>
                        ...
                        <div className='ml-2.5' style={{ lineHeight: '1' }}>
                            <h6 className='m-0'>Hacker News</h6>
                            <p className='text-sm font-thin m-0'>Frontpage</p>
                        </div>
                    </div>
                    <div className='flex gap-5 items-center'>
                        <img className='w-5 h-5 cursor-pointer' src="https://img.icons8.com/ios-filled/50/ffffff/search--v1.png" alt="search--v1" />
